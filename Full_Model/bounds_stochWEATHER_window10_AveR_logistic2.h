...
else if (i==11)	{	low = 0.000001;			high = 0.500;	}		//sdr
else if (i==12)	{	low = 0.000001;			high = 0.300;	}		//sdf
...
else if (i==16)	{	low = 400.0;			high = 700.0;	}		//CK// C end	
...
else if (i==19)	{	low = 150.0;			high = 350.0;	}		//CK// stop2 R_end.  time when resting spores stop blooming

else if (i==20)	{	low = 1.0;			high = 13.50;	}		//CK// open_C
...
else if (i==21)	{	low = 0.50;			high = 3.00;	}		//CK// Rain scaling parameter func 2
//else if (i==21)	{	low = 0.0000001;			high = 0.2;	}		//CK// temp scaling parameter

else if (i==22)	{	low = -2.50;			high = -0.5;	}		//CK// RH scaling parameter

else if (i==23)	{	low = -2.50;			high = -0.60;	}		//CK// temp scaling parameter for muF
...
else if (i==25)	{	low = 1.1;			high = 13.50;	}		//CK// open_R

else if (i==26)	{	low = -0.5;			high = 3.20;	}		// rain_P2

else if (i==27)	{	low = 40.0;			high = 120.0;	}		//CK// R_start.  time when resting spores start blooming
...
else if (i==28)	{	low = 250.0;			high = 370.0;	}		//CK// size_S. effect of size on susceptibility.

else if (i==29)	{	low = -3.0;			high = -0.5;	}		//CK// rain_P3
...
for (i=1;i<=num_adj_pars;i++)	{
	if ((i==2||i==3||i==4||i==5||i==6||i==7||i==9||i==10||i==11||i==12||i==13||i==14||i==15||i==16||i==17||i==18||i==19||i==20||i==21||i==22||i==23||i==24||i==25||i==26||i==27||i==28||i==29) && (i!=pro))	{
		...
		//	Params->PARS[i] = 0.002;
		//}
		else if (i==4||i==5||i==8||i==10||i==15)	{	//CK// set virus parameters to 0. NO VIRUS
			Params->PARS[i] = 0.0;
		}
