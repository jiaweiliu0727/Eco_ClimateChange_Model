## This directory includes code of full model to generate the average fraction infected across realizations and years (and rough variance across years), for each location in the projected weather data (historical/future).
...
In parhoodCCupdate_avevar.c, change the initialS (line 34), initialR (line 37), which population to run (line 125), whether to print out all the values across realizations (line 211) and the file name of that (line 135) if necessary.
...
** Format of weather data: each line has four numbers separated by space, indicating rainfall, minimum relative humidity, maximum daily temperature and minimum daily temperature. 
The order of lines: year 1, location 1, day 1
                    year 1 location 1, day 2
                    ......
                    year 1, location 1, day 365
                    year 1, location 2, day 1
                    year 1, location 2, day 2
                    ......
                    year 1, final location, day 365
                    year 2, location 1 day 1
                    ......

## Compiling the code and submitting the job:
./BatchMake_beast.sh parhoodCCupdate_avevar
...
module load gsl/2.4
module load openmpi
mpiexec ./parhoodCCupdate_avevar      
